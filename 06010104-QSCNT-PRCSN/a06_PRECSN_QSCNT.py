...
plt.ylabel('max $l_2$ error',  fontsize=fs, labelpad=0.25)
plt.xlabel('runtimes [sec]', fontsize=fs, labelpad=0.25)
plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.21), ncol=3, fontsize=fs-1)
plt.grid()

# Save plot
plt.savefig(save_plot_to + '06010104-QSCNT-PRCSN-NZROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010104-QSCNT-PRCSN-NZROQ.pdf', save_plot_to + '06010104-QSCNT-PRCSN-NZROQ.pdf'])
