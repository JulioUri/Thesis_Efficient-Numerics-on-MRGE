...
# Save plot
plt.savefig(save_plot_to + '06020306-DATA1-PRCSN-NZROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020306-DATA1-PRCSN-NZROQ.pdf', save_plot_to + '06020306-DATA1-PRCSN-NZROQ.pdf'])
