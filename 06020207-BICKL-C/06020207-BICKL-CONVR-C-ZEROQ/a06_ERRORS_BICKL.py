...
plt.savefig(save_plot_to + '06020207-BICKL-CNVRG-C-ZEROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020207-BICKL-CNVRG-C-ZEROQ.pdf', save_plot_to + '06020207-BICKL-CNVRG-C-ZEROQ.pdf'])
