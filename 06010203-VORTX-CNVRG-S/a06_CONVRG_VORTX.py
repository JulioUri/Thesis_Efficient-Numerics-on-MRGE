...
###############################################################################
#
omega_value  = 1.                         # Angular velocity of the field (1 turn per second)
...
#
# Warning
print("\nRunning this script could take up to several hours. \n")
...
# create header
head = ["S:", str(round(S_v[0], 2)), str(round(S_v[1], 2)), str(round(S_v[2], 2)),
              str(round(S_v[3], 2)), str(round(S_v[4], 2)), str(round(S_v[5], 2)),
              str(round(S_v[6], 2))]
...
plt.savefig(save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[0], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[0], 2))  + '.pdf', save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[0], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[1], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[1], 2))  + '.pdf', save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[1], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[2], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[2], 2))  + '.pdf', save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[2], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[3], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[3], 2))  + '.pdf', save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[3], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[4], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[4], 2))  + '.pdf', save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[4], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[5], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[5], 2))  + '.pdf', save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[5], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[6], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[6], 2))  + '.pdf', save_plot_to + '06010203-VORTX-CNVRG-ZEROQ-S=' + str(round(S_v[6], 2))  + '.pdf'])
