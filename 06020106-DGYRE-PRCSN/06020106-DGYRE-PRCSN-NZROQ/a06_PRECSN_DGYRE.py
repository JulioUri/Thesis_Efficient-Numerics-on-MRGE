...
plt.vlines(x = tend * T_scale, ymin = 6e-14, ymax = 2e-1,
           colors     = 'black', linestyles = 'solid')

# Define text on plot
plt.text(4e-2, 5e-14, 'Faster than \n  Real Time', weight='bold', fontsize=fs)
plt.annotate('', xy=(2e-2, 1e-14), xytext=(0.8, 1e-14), 
             arrowprops=dict(facecolor='black', shrink=0.,
                             width=2, headwidth=8, headlength=7))
plt.text(1.3, 5e-14, 'Slower than \nReal Time', weight='bold', fontsize=fs)
plt.annotate('', xy=(48, 1e-14), xytext=(1.3, 1e-14), 
             arrowprops=dict(facecolor='black', shrink=0.,
                             width=2, headwidth=8, headlength=7))
...
# Save plot
plt.savefig(save_plot_to + '06020106-DGYRE-PRCSN-NZROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020106-DGYRE-PRCSN-NZROQ.pdf', save_plot_to + '06020106-DGYRE-PRCSN-NZROQ.pdf'])
