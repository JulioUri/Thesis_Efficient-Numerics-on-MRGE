...
"""
Created on Tue Feb 06 16:14:22 2024
...
plt.vlines(x = tend * T_scale, ymin = 7e-13, ymax = 2e-2,
           colors     = 'black', linestyles = 'solid')

# Define text on plot
plt.text(1.1e-2, 5e-12, 'Faster than \n  Real Time', weight='bold', fontsize=8)
...
# Save plot
plt.savefig(save_plot_to + '06010306-OSCLT-PRCSN-NZROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010306-OSCLT-PRCSN-NZROQ.pdf', save_plot_to + '06010306-OSCLT-PRCSN-NZROQ.pdf'])
