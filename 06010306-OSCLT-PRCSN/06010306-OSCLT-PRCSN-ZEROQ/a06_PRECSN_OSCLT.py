...
# Save plot
plt.savefig(save_plot_to + '06010306-OSCLT-PRCSN-ZEROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010306-OSCLT-PRCSN-ZEROQ.pdf', save_plot_to + '06010306-OSCLT-PRCSN-ZEROQ.pdf'])
