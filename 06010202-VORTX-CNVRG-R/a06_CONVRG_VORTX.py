...
plt.text(130, 7e-10, "$N^{-3}$", color='grey')
...
plt.savefig(save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf', save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf'])
...
plt.text(130, 7e-11, "$N^{-3}$", color='grey')
...
plt.savefig(save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf', save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf'])
...
plt.plot(L_v[2:4], 2.*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(145, 5e-4, "$N^{-2}$", color='grey')
plt.plot(L_v[1:3], 5e-2*L_v[1:3]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(55, 1e-9, "$N^{-3}$", color='grey')
plt.plot(L_v[2:4], 2e-2*L_v[2:4]**(-4.0), '--', color='grey', linewidth=1.0)
plt.text(140, 1e-10, "$N^{-4}$", color='grey')
...
plt.savefig(save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf', save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf'])
...
plt.plot(L_v[2:4], 7.*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(145, 1.5e-3, "$N^{-2}$", color='grey')
plt.plot(L_v[2:4], 4e-2*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(130, 8e-11, "$N^{-3}$", color='grey')
...
plt.savefig(save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf', save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf'])
...
plt.plot(L_v[2:4], 12.*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(145, 1.5e-3, "$N^{-2}$", color='grey')
plt.plot(L_v[2:4], 8e-2*L_v[2:4]**(-3.0), '--', color='grey', linewidth=1.0)
plt.text(130, 8e-11, "$N^{-3}$", color='grey')
...
plt.savefig(save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf', save_plot_to + '06010202-VORTX-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf'])
