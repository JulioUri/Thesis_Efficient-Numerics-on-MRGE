...
plt.savefig(save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf', save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf', save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf', save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf', save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf', save_plot_to + '06020204-BICKL-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf'])
