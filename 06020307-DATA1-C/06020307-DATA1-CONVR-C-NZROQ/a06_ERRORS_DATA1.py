...
plt.xscale("log")
plt.yscale("log")
plt.ylim(2e-7,3e-2) # plt.ylim(7e-3,1e-2)
...
plt.savefig(save_plot_to + '06020307-DATA1-CNVRG-C-NZROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020307-DATA1-CNVRG-C-NZROQ.pdf', save_plot_to + '06020307-DATA1-CNVRG-C-NZROQ.pdf'])
