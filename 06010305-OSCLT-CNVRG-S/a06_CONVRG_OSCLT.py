...
# Define parameters to obtain S (Remember S=rad_p[j]**2/(3*nu_f*T_scale)):
...
vely         = 0.1
v0           = np.array([velx, vely])        # Initial velocity (nondimensional)
...
for j in range(0, len(S_v)):
    ...
    for ll in range(0, len(L_v)):
        ...
        try:
            Prasath_err     = Prasath_pos[:,1] - Oscillatory_particle.pos_vec[:,1]
            Prasath_err_max = np.linalg.norm(Prasath_err, ord=2)
        ...
        Daitche_err     = Daitche_particle.pos_vec[:,1] - Oscillatory_particle.pos_vec[:,1]
        Daitche_err_max = np.linalg.norm(Daitche_err, ord=2)
...
plt.savefig(save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[0], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[0], 2))  + '.pdf', save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[0], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[1], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[1], 2))  + '.pdf', save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[1], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[2], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[2], 2))  + '.pdf', save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[2], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[3], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[3], 2))  + '.pdf', save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[3], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[4], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[4], 2))  + '.pdf', save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[4], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[5], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[5], 2))  + '.pdf', save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[5], 2))  + '.pdf'])
...
plt.savefig(save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[6], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[6], 2))  + '.pdf', save_plot_to + '06010305-OSCLT-CNVRG-ZEROQ-S=' + str(round(S_v[6], 2))  + '.pdf'])
