...
plt.yscale("log")
# plt.ylim(1e-14,1e-1)
plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.25), ncol=2, fontsize=fs)
plt.xlabel('c values', fontsize=fs, labelpad=0.25)
plt.ylabel('$l_2$ error at last node', fontsize=fs, labelpad=0.25)
plt.grid()

plt.savefig(save_plot_to + '06010205-VORTX-CNVRG-C.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010205-VORTX-CNVRG-C.pdf', save_plot_to + '06010205-VORTX-CNVRG-C.pdf'])
