...
plt.vlines(x = tend * T_scale, ymin = 6e-11, ymax = 2e-1,
...
# Save plot
plt.savefig(save_plot_to + '06020206-BICKL-PRCSN-NZROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020206-BICKL-PRCSN-NZROQ.pdf', save_plot_to + '06020206-BICKL-PRCSN-NZROQ.pdf'])
