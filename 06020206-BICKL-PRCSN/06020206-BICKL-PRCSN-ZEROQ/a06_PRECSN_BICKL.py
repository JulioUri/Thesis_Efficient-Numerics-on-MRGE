...
# Save plot
plt.savefig(save_plot_to + '06020206-BICKL-PRCSN-ZEROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020206-BICKL-PRCSN-ZEROQ.pdf', save_plot_to + '06020206-BICKL-PRCSN-ZEROQ.pdf'])
