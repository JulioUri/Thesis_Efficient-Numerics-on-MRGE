...
# Define text on plot
plt.text(1.2e-2, 5e-12, 'Faster than \n  Real Time', weight='bold', fontsize=8)
...
plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.25), ncol=3, fontsize=6)
plt.grid()

# Save plot
plt.savefig(save_plot_to + '06010204-VORTX-PRCSN-ZEROQ.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010204-VORTX-PRCSN-ZEROQ.pdf', save_plot_to + '06010204-VORTX-PRCSN-ZEROQ.pdf'])
