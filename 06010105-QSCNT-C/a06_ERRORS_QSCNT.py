...
for j in range(0, len(c_v)):    
    ...
    ################################
    #
    Analytic_particle  = maxey_riley_relaxing(1, y0, v0, tini,
...
plt.savefig(save_plot_to + '06010105-QSCNT-CNVRG-C.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010105-QSCNT-CNVRG-C.pdf', save_plot_to + '06010105-QSCNT-CNVRG-C.pdf'])
