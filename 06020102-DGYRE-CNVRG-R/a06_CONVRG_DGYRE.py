...
y0           = np.array([1.0, 0.5]) / L_scale # Initial position (nondimensional)
...
# plt.plot(L_v[1:3], 1.*L_v[1:3]**(-2.0), '--', color='grey', linewidth=1.0)
# plt.text(65, 6e-4, "$N^{-2}$", color='grey')
# plt.plot(L_v[1:3], 1e-1*L_v[1:3]**(-4.0), '--', color='grey', linewidth=1.0)
# plt.text(60, 7e-11, "$N^{-4}$", color='grey')
...
plt.savefig(save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf', save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[0], 2))  + '.pdf'])
...
# plt.plot(L_v[1:3], 5e-1*L_v[1:3]**(-2.0), '--', color='grey', linewidth=1.0)
# plt.text(65, 2e-4, "$N^{-2}$", color='grey')
# plt.plot(L_v[1:3], 1e-1*L_v[1:3]**(-4.0), '--', color='grey', linewidth=1.0)
# plt.text(60, 9e-11, "$N^{-4}$", color='grey')
...
plt.savefig(save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf', save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[1], 2))  + '.pdf'])
...
# plt.plot(L_v[1:3], 3e-1*L_v[1:3]**(-2.0), '--', color='grey', linewidth=1.0)
# plt.text(65, 1e-4, "$N^{-2}$", color='grey')
# plt.plot(L_v[1:3], 3e-2*L_v[1:3]**(-3.0), '--', color='grey', linewidth=1.0)
# plt.text(60, 1e-9, "$N^{-3}$", color='grey')
# plt.plot(L_v[1:3], 4e-5*L_v[1:3]**(-4.0), '--', color='grey', linewidth=1.0)
# plt.text(60, 3e-14, "$N^{-4}$", color='grey')
...
plt.savefig(save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf', save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[2], 2))  + '.pdf'])
...
# plt.plot(L_v[1:3], 5e-1*L_v[1:3]**(-2.0), '--', color='grey', linewidth=1.0)
# plt.text(65, 2e-4, "$N^{-2}$", color='grey')
# plt.plot(L_v[1:3], 3e-1*L_v[1:3]**(-4.0), '--', color='grey', linewidth=1.0)
# plt.text(60, 2e-10, "$N^{-4}$", color='grey')
...
plt.savefig(save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf', save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[3], 2))  + '.pdf'])
...
# plt.plot(L_v[1:3], 2.*L_v[1:3]**(-2.0), '--', color='grey', linewidth=1.0)
# plt.text(65, 1e-3, "$N^{-2}$", color='grey')
# plt.plot(L_v[1:3], 1.*L_v[1:3]**(-4.0), '--', color='grey', linewidth=1.0)
# plt.text(60, 7e-10, "$N^{-4}$", color='grey')
...
plt.savefig(save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf', save_plot_to + '06020102-DGYRE-CNVRG-ZEROQ-R=' + str(round(R_v[4], 2))  + '.pdf'])
