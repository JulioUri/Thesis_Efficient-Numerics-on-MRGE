...
plt.plot(L_v[2:4], 1e-2*L_v[2:4]**(-1.0), '--', color='grey', linewidth=1.0)
plt.text(135, 4e-7, "$N^{-1}$", color='grey')
...
plt.savefig(save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[0], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[0], 2))  + '.pdf', save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[0], 2))  + '.pdf'])
...
plt.text(135, .8e-7, "$N^{-1}$", color='grey')
...
plt.savefig(save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[1], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[1], 2))  + '.pdf', save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[1], 2))  + '.pdf'])
...
plt.text(135, .5e-7, "$N^{-1}$", color='grey')
plt.plot(L_v[2:4], 8e-6*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(125, 1e-12, "$N^{-2}$", color='grey')
...
plt.savefig(save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[2], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[2], 2))  + '.pdf', save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[2], 2))  + '.pdf'])
...
plt.plot(L_v[2:4], 8e-4*L_v[2:4]**(-1.0), '--', color='grey', linewidth=1.0)
plt.text(135, .5e-7, "$N^{-1}$", color='grey')
plt.plot(L_v[2:4], 8e-6*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(125, 1e-12, "$N^{-2}$", color='grey')
...
plt.savefig(save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[3], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[3], 2))  + '.pdf', save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[3], 2))  + '.pdf'])
...
plt.plot(L_v[2:4], 9e-4*L_v[2:4]**(-1.0), '--', color='grey', linewidth=1.0)
plt.text(135, .5e-7, "$N^{-1}$", color='grey')
plt.plot(L_v[2:4], 3e-6*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(125, 6e-13, "$N^{-2}$", color='grey')
...
plt.savefig(save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[4], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[4], 2))  + '.pdf', save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[4], 2))  + '.pdf'])
...
plt.plot(L_v, Prasath_err_dic[5], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw, markersize=ms)
plt.plot(L_v, Trap_err_dic[5],    'v-', color='green',  label="FD2 + Trap. Rule",      linewidth=lw, markersize=ms)
plt.plot(L_v, IMEX2_err_dic[5],   's-', color='violet', label="FD2 + IMEX2",           linewidth=lw, markersize=ms)
plt.plot(L_v, Daitche_err_dic[5], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw, markersize=ms)
plt.plot(L_v, IMEX4_err_dic[5],   'o-', color='red',    label="FD4 + IMEX4",           linewidth=lw, markersize=ms)
plt.plot(L_v, DIRK4_err_dic[5],   '+-', color='blue',   label="FD4 + DIRK4",           linewidth=lw, markersize=ms)
...
plt.savefig(save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[5], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[5], 2))  + '.pdf', save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[5], 2))  + '.pdf'])
...
plt.plot(L_v[2:4], 2e-4*L_v[2:4]**(-1.0), '--', color='grey', linewidth=1.0)
plt.text(135, 1e-8, "$N^{-1}$", color='grey')
plt.plot(L_v[2:4], 9e-7*L_v[2:4]**(-2.0), '--', color='grey', linewidth=1.0)
plt.text(125, 2e-13, "$N^{-2}$", color='grey')

plt.plot(L_v, Prasath_err_dic[6], 'P-', color='darkgoldenrod', label="Prasath et al. (2019)", linewidth=lw, markersize=ms)
plt.plot(L_v, Trap_err_dic[6],    'v-', color='green',  label="FD2 + Trap. Rule",      linewidth=lw, markersize=ms)
plt.plot(L_v, IMEX2_err_dic[6],   's-', color='violet', label="FD2 + IMEX2",           linewidth=lw, markersize=ms)
plt.plot(L_v, Daitche_err_dic[6], 'd-', color='darkturquoise',   label="Daitche, " + str(order_Daitche) + " order", linewidth=lw, markersize=ms)
plt.plot(L_v, IMEX4_err_dic[6],   'o-', color='red',    label="FD4 + IMEX4",           linewidth=lw, markersize=ms)
plt.plot(L_v, DIRK4_err_dic[6],   '+-', color='blue',   label="FD4 + DIRK4",           linewidth=lw, markersize=ms)
...
plt.savefig(save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[6], 2))  + '.pdf', format='pdf', dpi=500)

call(["pdfcrop", save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[6], 2))  + '.pdf', save_plot_to + '06010103-QSCNT-CNVRG-NZROQ-S=' + str(round(S_v[6], 2))  + '.pdf'])
...
##########
#
plt.figure(8, layout='tight', figsize=fgsz)
