...
plt.savefig(save_plot_to + '06020201-BICKL-TRJCTa.pdf', format='pdf', dpi=400, bbox_inches='tight')

call(["pdfcrop", save_plot_to + '06020201-BICKL-TRJCTa.pdf', save_plot_to + '06020201-BICKL-TRJCTa.pdf'])
...
plt.savefig(save_plot_to + '06020201-BICKL-TRJCTb.pdf', format='pdf', dpi=400, bbox_inches='tight')

call(["pdfcrop", save_plot_to + '06020201-BICKL-TRJCTb.pdf', save_plot_to + '06020201-BICKL-TRJCTb.pdf'])
